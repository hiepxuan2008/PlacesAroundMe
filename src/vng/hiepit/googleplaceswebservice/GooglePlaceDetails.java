...
public class GooglePlaceDetails extends GooglePlacesAPIWebService {
	...
	private void procesJsonData() {
		...
		try {
			...
			String formatted_phone_number = resultObject.getString("formatted_phone_number");
			String international_phone_number = resultObject.getString("international_phone_number");
			...
			for (int i = 0; i < reviewsArray.length(); ++i) {
				...
				Review review = new Review(author_name, author_url, rating, text, time);
